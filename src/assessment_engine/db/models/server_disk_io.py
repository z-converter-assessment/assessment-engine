...
class ServerDiskIo(Base):
    ...
    ops_read: Mapped[int | None] = mapped_column(BigInteger)
    ops_write: Mapped[int | None] = mapped_column(BigInteger)
    io_time_s: Mapped[float | None] = mapped_column(Float)
    op_read_time_s: Mapped[float | None] = mapped_column(Float)
    op_write_time_s: Mapped[float | None] = mapped_column(Float)
    pending_ops: Mapped[float | None] = mapped_column(Float)
