...
본 모듈 단일 헬퍼/상수 경유. SQL(db.repositories.query.metric)도 BOOT_TIME_JITTER_TOLERANCE 에서 파생한
초 단위 값을 bound parameter 로 사용해 단일 진실 유지. (보정값 저장 대안 검토·기각 — 정답 btime 부재로
