...
외부(deps·라우터)는 본 모듈에서 QueryService·외부 노출 심볼(DASHBOARD_TIME_RANGE·DeviceCategory 등)을 import.
...
from assessment_engine.web.services.query.metric import DeviceCategory, MetricQueryMixin
