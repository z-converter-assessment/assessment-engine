...
class ServerDetailResponse:
    ...
    sorted_services: list[ServiceItem] = field(default_factory=list[ServiceItem])
    sorted_listen_ports: list[ListenPortItem] = field(default_factory=list[ListenPortItem])
    known_services: list[ServiceItem] = field(default_factory=list[ServiceItem])
    show_unknown_badge: bool = False
