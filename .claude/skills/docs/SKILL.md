...
문서 규율 단일 진실 = `docs/README.md`(4원칙) + `docs/guides/wrap-up.md` Stage 4·5. 본 skill 은 절차만 가지고 체크리스트를 복제하지 않는다. develop PR 게이트가 본 skill 을 feature 영역으로 호출한다 (배치 근거는 wrap-up 0절).
