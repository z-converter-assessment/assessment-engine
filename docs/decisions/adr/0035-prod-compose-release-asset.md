...
- #F9 동시 갱신: `docker-compose.yml`·`docker-compose.override.yml`·`dev/dev-up.sh`·`release.yml`·`docs/operations/{release,deployment,env}.md`·`docs/guides/local-dev.md`·`README.md`·CLAUDE.md #A0·ADR 0033 정정 note.
