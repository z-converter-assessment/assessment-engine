...
- `docs/reference/contracts/env.md` 안 `LLM_PROVIDER` + `LLM_MOCK_LATENCY_SECONDS` 카탈로그 제거
- `docs/guides/deploy.md` 안 multi-node 분리 catalog 정정
- `docs/explanation/products/server-report.md` + `environment-report.md` 안 mock.py 참조 → ollama.py 정정
...
- `docs/reference/contracts/env.md` `OLLAMA_*` 카탈로그
