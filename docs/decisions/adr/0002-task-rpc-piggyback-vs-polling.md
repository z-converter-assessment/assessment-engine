...
## 관련 문서
- 흐름·메시지 스키마·task_type enum: `docs/reference/contracts/agent-data.md` "Task RPC piggyback"
- Redis 키 정책: `docs/reference/redis.md` `task:pending` 항목
- 부가 시그널 + consumer 흐름: `docs/reference/consumer.md` "metrics 후처리" + "부가 시그널"
- CLAUDE.md B6: 결정 요약
