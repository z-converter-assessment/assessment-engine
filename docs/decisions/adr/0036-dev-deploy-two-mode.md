...
- #F9 동시 갱신: 루트 `.env.example`·`dev/.env.example` 헤더·`README.md`·`docs/guides/deploy.md`·`docs/guides/local-dev.md`·`docs/README.md`·CLAUDE.md #A0·`docker-compose.yml`·`dev/dev-up.sh` 주석의 퀵스타트 용어.
