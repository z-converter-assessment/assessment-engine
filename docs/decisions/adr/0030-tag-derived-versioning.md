...
| `docs/guides/release.md`·README·github-setup.md·dependencies.md | 갱신 | tag-derived 흐름 |
| `docs/decisions/adr/0028-*.md` | Superseded by 0030 | |
...
| `docs/guides/release.md` | 2절 흐름에 single-source·가드 반영 + 7절 한계 "stable semver only (prerelease 미지원)" 추가 |
| `docs/decisions/adr/README.md` | 0030 행 요약에 derive 가드 정정 한 줄 |
...
| `docs/decisions/adr/README.md` | 0030 행 요약에 본 정정 한 줄 |
...
- `docs/guides/release.md` — release ceremony 단일 진실
