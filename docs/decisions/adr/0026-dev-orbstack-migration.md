...
상태: Superseded by ADR 0037 (2026-05-31) — homeserver Linux 이전으로 OrbStack(macOS)에서 libvirt(KVM) 재전환. 현행 dev 가상화 단일 진실 = `docs/development/pipeline.md`·`windows-vm.md`. 본 ADR 은 OrbStack 시기 역사 기록으로 보존 (불변 규약).
