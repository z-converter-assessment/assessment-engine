...
기존 자산:
- aio-pika 비동기 consumer 프로세스 패턴 (`docs/reference/consumer.md`)
- RabbitMQ 토폴로지·DLQ (`docs/reference/rabbitmq.md`)
...
- CLAUDE.md #A0 범위·#B 메시지 데이터 계약·#C1 키 제약 갱신 의무 (routing key 표는 `docs/reference/rabbitmq.md`)
- `docs/reference/consumer.md` 워커 구현 시 참조 패턴
- `docs/guides/migrate.md` `diagnostic_jobs` 마이그레이션 절차
