...
- #F9 동시 갱신: `dev/dev-up.sh` · `dev/.env.example` · `config.py`(discovery·zdm 주석/default) · `dev_zdm_mock.py` · `list.js` · `docs/reference/contracts/env.md` · `docs/development/pipeline.md` · `docs/development/windows-vm.md`.
