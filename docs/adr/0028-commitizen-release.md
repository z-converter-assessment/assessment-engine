...
| `docs/operations/release.md`·`docs/development/github-setup.md`·`docs/development/dependencies.md`·`docs/README.md`·README | 갱신 | release ceremony·UI setup·version marker |
| `docs/adr/0013-*.md` | Superseded by 0028 | |
...
- `docs/development/github-setup.md` — GitHub UI/ruleset 설정 카탈로그
