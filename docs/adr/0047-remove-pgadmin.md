...
- 영구 문서 현황화(#F12 덮어쓰기): `README.md`·`docs/development/docker.md`·`docs/operations/deployment.md`·
  `docs/operations/env.md` 의 pgAdmin 서술·`PGADMIN_*` 키·5050 포트 제거.
...
- #F9 동시 갱신: `docker/pgadmin/`(삭제)·`docker-compose.yml`·`docker-compose.override.yml`·
  ...
  `README.md`·`docs/development/docker.md`·`docs/operations/{deployment,env}.md`·ADR 인덱스.
