...
문서는 목적으로 나뉜다. 고치기 전에 그 사실이 어느 목적에 속하는지 정한다.

| 디렉토리 | 담는 것 |
|----------|---------|
| `docs/reference/` | 지금 어떻게 도나 — 동작·구성·얼어붙은 계약 |
| `docs/guides/` | 어떻게 하나 — 작업 절차 |
| `docs/explanation/` | 왜 이렇게 설계했나 — 한계·산출물 의의 |
| `docs/decisions/` | 왜 바꿨나 — 결정 기록. 고치지 않고 덧붙인다 |
